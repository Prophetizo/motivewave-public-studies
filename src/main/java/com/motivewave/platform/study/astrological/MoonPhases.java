...
public class MoonPhases extends com.motivewave.platform.sdk.study.Study 
{
  ...
  private static java.util.Date toGMTDate(int day, int month, int year, int hour, int min, int sec, int millis) {
    synchronized(GMTCal) {
  ...
  static {
    ...
    // 2024
    registerFullMoon(1, 25, 2024, 17, 54);
    registerFullMoon(2, 24, 2024, 12, 30);
    registerFullMoon(3, 25, 2024, 7, 0);
    registerFullMoon(4, 24, 2024, 0, 48);
    registerFullMoon(5, 23, 2024, 14, 53);
    registerFullMoon(6, 22, 2024, 2, 07);
    registerFullMoon(7, 21, 2024, 11, 17);
    registerFullMoon(8, 19, 2024, 19, 25);
    registerFullMoon(9, 18, 2024, 3, 34);
    registerFullMoon(10, 17, 2024, 12, 26);
    registerFullMoon(11, 15, 2024, 21, 28);
    registerFullMoon(12, 15, 2024, 0, 1);

    // 2025
    registerFullMoon(1, 13, 2025, 20, 26);
    registerFullMoon(2, 12, 2025, 13, 53);
    registerFullMoon(3, 14, 2025, 6, 54);
    registerFullMoon(4, 13, 2025, 1, 22);
    registerFullMoon(5, 12, 2025, 17, 55);
    registerFullMoon(6, 11, 2025, 8, 43);
    registerFullMoon(7, 10, 2025, 21, 36);
    registerFullMoon(8, 9, 2025, 8, 55);
    registerFullMoon(9, 7, 2025, 19, 8);
    registerFullMoon(10, 7, 2025, 4, 47);
    registerFullMoon(11, 5, 2025, 13, 19);
    registerFullMoon(12, 4, 2025, 23, 14);

    // 2026
    registerFullMoon(1, 3, 2026, 10, 2);
    registerFullMoon(2, 1, 2026, 22, 9);
    registerFullMoon(3, 3, 2026, 11, 37);
    registerFullMoon(4, 2, 2026, 3, 11);
    registerFullMoon(5, 1, 2026, 18, 23);
    registerFullMoon(5, 31, 2026, 9, 45);
    registerFullMoon(6, 30, 2026, 12, 56);
    registerFullMoon(7, 29, 2026, 15, 35);
    registerFullMoon(8, 28, 2026, 5, 18);
    registerFullMoon(9, 26, 2026, 17, 49);
    registerFullMoon(10, 26, 2026, 4, 11);
    registerFullMoon(11, 24, 2026, 14, 53);
    registerFullMoon(12, 24, 2026, 1, 28);

    // 2027
    registerFullMoon(1, 22, 2027, 12, 17);
    registerFullMoon(2, 20, 2027, 23, 23);
    registerFullMoon(3, 22, 2027, 10, 43);
    registerFullMoon(4, 20, 2027, 23, 27);
    registerFullMoon(5, 20, 2027, 11, 59);
    registerFullMoon(6, 19, 2027, 1, 44);
    registerFullMoon(7, 18, 2027, 16, 44);
    registerFullMoon(8, 17, 2027, 8, 28);
    registerFullMoon(9, 16, 2027, 0, 3);
    registerFullMoon(10, 15, 2027, 14, 47);
    registerFullMoon(11, 14, 2027, 3, 25);
    registerFullMoon(12, 13, 2027, 16, 8);

    // 2028
    registerFullMoon(1, 12, 2028, 4, 3);
    registerFullMoon(2, 10, 2028, 15, 3);
    registerFullMoon(3, 11, 2028, 1, 6);
    registerFullMoon(4, 9, 2028, 11, 26);
    registerFullMoon(5, 8, 2028, 20, 48);
    registerFullMoon(6, 7, 2028, 7, 8);
    registerFullMoon(7, 6, 2028, 19, 10);
    registerFullMoon(8, 5, 2028, 9, 9);
    registerFullMoon(9, 4, 2028, 0, 47);
    registerFullMoon(10, 3, 2028, 17, 25);
    registerFullMoon(11, 2, 2028, 9, 17);
    registerFullMoon(12, 2, 2028, 1, 40);
    registerFullMoon(12, 31, 2028, 16, 48);

    // 2029
    registerFullMoon(1, 30, 2029, 6, 3);
    registerFullMoon(2, 28, 2029, 17, 10);
    registerFullMoon(3, 30, 2029, 3, 26);
    registerFullMoon(4, 28, 2029, 11, 36);
    registerFullMoon(5, 27, 2029, 19, 37);
    registerFullMoon(6, 26, 2029, 4, 22);
    registerFullMoon(7, 25, 2029, 14, 35);
    registerFullMoon(8, 24, 2029, 2, 51);
    registerFullMoon(9, 22, 2029, 17, 29);
    registerFullMoon(10, 22, 2029, 10, 27);
    registerFullMoon(11, 21, 2029, 4, 2);
    registerFullMoon(12, 20, 2029, 22, 46);

    // 2030
    registerFullMoon(1, 19, 2030, 15, 54);
    registerFullMoon(2, 18, 2030, 6, 19);
    registerFullMoon(3, 19, 2030, 17, 56);
    registerFullMoon(4, 18, 2030, 4, 19);
    registerFullMoon(5, 17, 2030, 12, 19);
    registerFullMoon(6, 15, 2030, 19, 40);
    registerFullMoon(7, 15, 2030, 3, 12);
    registerFullMoon(8, 13, 2030, 11, 44);
    registerFullMoon(9, 11, 2030, 22, 17);
    registerFullMoon(10, 11, 2030, 11, 46);
    registerFullMoon(11, 10, 2030, 3, 30);
    registerFullMoon(12, 9, 2030, 22, 40);

    // 2031
    registerFullMoon(1, 8, 2031, 18, 25);
    registerFullMoon(2, 7, 2031, 12, 46);
    registerFullMoon(3, 9, 2031, 4, 29);
    registerFullMoon(4, 7, 2031, 18, 21);
    registerFullMoon(5, 7, 2031, 4, 39);
    registerFullMoon(6, 5, 2031, 12, 58);
    registerFullMoon(7, 4, 2031, 20, 1);
    registerFullMoon(8, 3, 2031, 2, 45);
    registerFullMoon(9, 1, 2031, 10, 20);
    registerFullMoon(9, 30, 2031, 19, 57);
    registerFullMoon(10, 30, 2031, 7, 32);
    registerFullMoon(11, 28, 2031, 23, 18);
    registerFullMoon(12, 28, 2031, 17, 33);

    // 2032
    registerFullMoon(1, 27, 2032, 12, 52);
    registerFullMoon(2, 26, 2032, 7, 43);
    registerFullMoon(3, 27, 2032, 0, 46);
    registerFullMoon(4, 25, 2032, 16, 9);
    registerFullMoon(5, 25, 2032, 3, 37);
    registerFullMoon(6, 23, 2032, 12, 32);
    registerFullMoon(7, 22, 2032, 19, 51);
    registerFullMoon(8, 21, 2032, 2, 46);
    registerFullMoon(9, 19, 2032, 10, 30);
    registerFullMoon(10, 18, 2032, 19, 58);
    registerFullMoon(11, 17, 2032, 6, 42);
    registerFullMoon(12, 16, 2032, 20, 49);

    // 2033
    registerFullMoon(1, 15, 2033, 13, 7);
    registerFullMoon(2, 14, 2033, 7, 4);
    registerFullMoon(3, 16, 2033, 1, 37);
    registerFullMoon(4, 14, 2033, 20, 17);
    registerFullMoon(5, 14, 2033, 11, 42);
    registerFullMoon(6, 13, 2033, 0, 19);
    registerFullMoon(7, 12, 2033, 10, 28);
    registerFullMoon(8, 10, 2033, 19, 7);
    registerFullMoon(9, 9, 2033, 3, 20);
    registerFullMoon(10, 8, 2033, 11, 58);
    registerFullMoon(11, 6, 2033, 20, 32);
    registerFullMoon(12, 6, 2033, 7, 22);

    // 2034
    registerFullMoon(1, 4, 2034, 19, 47);
    registerFullMoon(2, 3, 2034, 10, 4);
    registerFullMoon(3, 5, 2034, 2, 10);
    registerFullMoon(4, 3, 2034, 20, 18);
    registerFullMoon(5, 3, 2034, 13, 15);
    registerFullMoon(6, 2, 2034, 4, 54);
    registerFullMoon(7, 1, 2034, 18, 44);
    registerFullMoon(7, 31, 2034, 6, 54);
    registerFullMoon(8, 29, 2034, 17, 49);
    registerFullMoon(9, 28, 2034, 3, 56);
    registerFullMoon(10, 27, 2034, 13, 42);
    registerFullMoon(11, 25, 2034, 20, 32);
    registerFullMoon(12, 25, 2034, 8, 54);

    // 2035
    registerFullMoon(1, 23, 2035, 20, 16);
    registerFullMoon(2, 22, 2035, 8, 53);
    registerFullMoon(3, 23, 2035, 20, 42);
    registerFullMoon(4, 22, 2035, 14, 20);
    registerFullMoon(5, 22, 2035, 5, 25);
    registerFullMoon(6, 20, 2035, 20, 37);
    registerFullMoon(7, 20, 2035, 11, 36);
    registerFullMoon(8, 19, 2035, 2, 0);
    registerFullMoon(9, 17, 2035, 15, 23);
    registerFullMoon(10, 17, 2035, 3, 35);
    registerFullMoon(11, 15, 2035, 13, 48);
    registerFullMoon(12, 15, 2035, 12, 33);
