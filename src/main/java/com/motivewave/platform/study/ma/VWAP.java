...
public class VWAP extends Study 
{
  ...
  protected void calculateValues(DataContext ctx)
  {
    ...
    useSeriesBS = settings.getBoolean(USE_SERIES_BS);
    String rthData = settings.getString(RTH);
    rth = ctx.isRTH();
    ...
    calculated = true;
    bandStd1 = settings.getDouble(BAND_STD1);
    bandStd2 = settings.getDouble(BAND_STD2);
    bandStd3 = settings.getDouble(BAND_STD3);
